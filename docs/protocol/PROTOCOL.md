...
get_group_links            (5 bytes)  [0x0F, 0x46, 0x02, 0x00, 0x03]
get_device_link            (5 bytes)  [0x0F, 0x46, 0x02, 0x00, 0x04]
```
...
curtainChainInfo:      [0x57, 0x0F, 0x46, 0x02, 0x00, 0x01]
curtainChainStatus:    [0x57, 0x0F, 0x46, 0x02, 0x00, 0x02]
```
